...
pip install langchain==1.3.14 langgraph==1.2.9 langchain-openai==1.4.1 \
    langchain-google-genai==4.3.1 langchain-community==0.4.2 langchain-chroma==1.1.0 \
    chromadb==1.5.9 pypdf==6.14.2 fastapi==0.140.0 "uvicorn[standard]==0.51.0" \
    python-multipart==0.0.32 pydantic==2.13.4 python-dotenv==1.2.2
```
...
(Grows as later tasks are added — chunking, vector store, retrieval, API, etc.)
